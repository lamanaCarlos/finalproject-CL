...
export const BuyerCommissionDetailPage = () => {
  ...
  const artistId = typeof commission.artistId === 'object' ? commission.artistId._id : commission.artistId;
  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
        {/* Back Button */}
        <Link to="/buyer/commissions" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card padding="lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Link to={`/artist/${artistId}`} className="flex items-center gap-2 text-primary-600 hover:underline">
